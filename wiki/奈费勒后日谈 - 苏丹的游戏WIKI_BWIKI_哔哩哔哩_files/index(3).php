...
@media (max-width: 767px) {
    ...
    .wiki-header .wiki-logo {
        ...
        max-width: calc(300 / 80 * 55px);
        height: 100%;
    }

    /*.wiki-header #navSearch {
        top: 50%;
...
/* purge */
.vectorMenu li#ca-purge.is-disabled {
    opacity: 1;
    pointer-events: auto;
}

.vectorMenu li#ca-purge.is-disabled::after {
    content: none;
}